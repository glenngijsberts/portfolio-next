...
export type Query = {
  ...
  websiteCollection?: Maybe<WebsiteCollection>;
};
...
export type QueryWebsiteCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  order?: InputMaybe<Array<InputMaybe<WebsiteOrder>>>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<WebsiteFilter>;
};
...
/** Website configuration [See type definition](https://app.contentful.com/spaces/e5j2vu5o9e01/content_types/website) */
export type WebsiteLinkedFromArgs = {
  allowedLocales?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export type WebsiteCollection = {
  __typename?: 'WebsiteCollection';
  items: Array<Maybe<Website>>;
  limit: Scalars['Int']['output'];
  skip: Scalars['Int']['output'];
  total: Scalars['Int']['output'];
};
...
export type WebsiteLinkingCollections = {
  __typename?: 'WebsiteLinkingCollections';
  entryCollection?: Maybe<EntryCollection>;
};


export type WebsiteLinkingCollectionsEntryCollectionArgs = {
  limit?: InputMaybe<Scalars['Int']['input']>;
  locale?: InputMaybe<Scalars['String']['input']>;
  preview?: InputMaybe<Scalars['Boolean']['input']>;
  skip?: InputMaybe<Scalars['Int']['input']>;
